...
try:
    ...
    # transformers >=5.0 removed the CLIPVisionTransformer name; fall back to
    # CLIPVisionModel, which wraps the same underlying network and has the
    # same forward signature for our purposes.
    CLIPVisionTransformer = CLIPVisionModel  # type: ignore
