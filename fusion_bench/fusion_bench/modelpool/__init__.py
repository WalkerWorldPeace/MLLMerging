...
_import_structure = {
    ...
    "causal_lm": ["CausalLMPool", "CausalLMBackbonePool", "TruncatedVocabCausalLMPool"],
...
if TYPE_CHECKING:
    ...
    from .causal_lm import CausalLMBackbonePool, CausalLMPool, TruncatedVocabCausalLMPool
