...
#Please provide the normalized bounding box coordinates (values between 0 and 1) of the region this sentence describes. Return coordinates as [x1, y1, x2, y2] where (x1, y1) is the top-left corner and (x2, y2) is the bottom-right corner:
